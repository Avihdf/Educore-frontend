...
const Profile = () => {
    ...
    const [previewImage, setPreviewImage] = useState(
        user?.profile_picture ? `${api_url}/uploads/${user.profile_picture}` : null
    );
    ...
    const handelSubmit = async (e) => {
        ...
        try {
            ...
            if (updateprofile.name && updateprofile.name !== user.name) {
                formData.append('name', updateprofile.name);
            } else {
                formData.append('name', user.name);
            }

            if (updateprofile.dob && updateprofile.dob !== formatDate(user.Date_of_Birth)) {
                formData.append('dob', updateprofile.dob);
            } else if (user.Date_of_Birth) {
                formData.append('dob', formatDate(user.Date_of_Birth));
            }
